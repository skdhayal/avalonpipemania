...
call "C:\util\flex_sdk_4.1.0.16076\bin\mxmlc.exe" -static-link-runtime-shared-libraries=true -sp=. --target-player=10.1.0 -debug -keep-as3-metadata -incremental=true -output=%2.swf -strict -sp=. %1/%2.as
goto :eof